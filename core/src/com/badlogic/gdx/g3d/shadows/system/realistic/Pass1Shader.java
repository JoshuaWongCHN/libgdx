...
public class Pass1Shader extends DefaultShader {
	...
	public static String getDefaultVertexShader () {
		if (defaultVertexShader == null)
			defaultVertexShader = Gdx.files.classpath("com/badlogic/gdx/g3d/shadows/system/realistic/pass1.vertex.glsl")
				.readString();
	...
	public static String getDefaultFragmentShader () {
		if (defaultFragmentShader == null)
			defaultFragmentShader = Gdx.files.classpath("com/badlogic/gdx/g3d/shadows/system/realistic/pass1.fragment" +
                    ".glsl")
				.readString();
