...
public class ReflectionCorrectnessTest extends GdxTest {
	...
	public void testCustomInterfaceClass () {
		Class clazz = ReflectionCorrectnessTest.AbstractInterfaceStatic.class;
	...
	public void testCustomInterfaceArrayClass () {
		Class clazz = ReflectionCorrectnessTest.AbstractInterfaceStatic[].class;
		Class componentClazz = ReflectionCorrectnessTest.AbstractInterfaceStatic.class;
		Expectation e = new Expectation().mArray().mCompType(componentClazz);
		doTest(clazz, e);
	}

	public void testCustomAnnotationClass () {
		Class clazz = ReflectionCorrectnessTest.AbstractAnnotationStatic.class;
	...
	public void testCustomAnnotationArrayClass () {
		Class clazz = ReflectionCorrectnessTest.AbstractAnnotationStatic[].class;
		Class componentClazz = ReflectionCorrectnessTest.AbstractAnnotationStatic.class;
		Expectation e = new Expectation().mArray().mCompType(componentClazz);
		doTest(clazz, e);
	}

	public void testCustomEnumClass () {
		Class clazz = ReflectionCorrectnessTest.StaticEnum.class;
	...
	public void testCustomEnumArrayClass () {
		Class clazz = ReflectionCorrectnessTest.StaticEnum[].class;
		Class componentClazz = ReflectionCorrectnessTest.StaticEnum.class;
		Expectation e = new Expectation().mArray().mCompType(componentClazz);
		doTest(clazz, e);
	}
